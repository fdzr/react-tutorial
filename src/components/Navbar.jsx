    ...
    return (
        <div className="w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg">
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className="flex items-center">
                    ...
                    <ul className="hidden md:flex">
                        ...
                        <li><Link to="pricing" smooth={true} offset={-85} duration={500}>Pricing</Link></li>
                    </ul>
                </div>
            ...
            <ul className={!nav? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className="border-b-2 border-zinc-300 w-full"><Link onClick={handleClose} to="platforms" smooth={true} offset={-200} duration={500}>Platforms</Link></li>
                <li className="border-b-2 border-zinc-300 w-full"><Link onClick={handleClose} to="pricing" smooth={true} offset={-85} duration={500}>Pricing</Link></li>
